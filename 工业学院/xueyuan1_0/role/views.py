...
from xueyuan1_0.role import role_api,role_bp
...
class Roles(Resource):
    def get(self):
        ...
        try:
            ...
            return {'status': 500, 'msg': '获取角色列表失败', 'data': str(e)}
    ...
    def post(self):
        ...
        try:
            ...
            return {'status': 500, 'msg': '添加角色失败', 'data': str(e)}
...
class Role(Resource):
    def delete(self, id):
        ...
        try:
            ...
            return {'status': 500, 'msg': '删除角色失败', 'data': str(e)}
    ...
    def put(self, id):
        ...
        try:
            ...
            parser.add_argument('desc', type=str, required=True, help='请输入角色描述')
            # 解析数据
